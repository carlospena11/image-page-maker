      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-white text-lg mb-8">
            Enterate de nuestras ofertas exclusivas suscribiéndote a nuestro
            boletín de noticias.
          </p>
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 max-w-lg">
            ...
            <Button 
              type="submit" 
              className="bg-white text-nuvik-blue hover:bg-gray-100 font-medium px-8 h-12"
            >
              Subscribe
            </Button>
          </form>
          ...
          <div className="flex gap-4 mt-8">
            ...
            <a href="https://pinterest.com" className="text-white hover:text-gray-200" aria-label="Pinterest">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
